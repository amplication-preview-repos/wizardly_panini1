...
class TeamCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LeaderboardCreateNestedManyWithoutTeamsInput,
  })
  @ValidateNested()
  @Type(() => LeaderboardCreateNestedManyWithoutTeamsInput)
  @IsOptional()
  @Field(() => LeaderboardCreateNestedManyWithoutTeamsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ParticipantCreateNestedManyWithoutTeamsInput,
  })
  @ValidateNested()
  @Type(() => ParticipantCreateNestedManyWithoutTeamsInput)
  @IsOptional()
  @Field(() => ParticipantCreateNestedManyWithoutTeamsInput, {
    nullable: true,
  })
