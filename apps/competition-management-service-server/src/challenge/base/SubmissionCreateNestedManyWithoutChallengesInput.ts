...
@InputType()
class SubmissionCreateNestedManyWithoutChallengesInput {
...
export { SubmissionCreateNestedManyWithoutChallengesInput as SubmissionCreateNestedManyWithoutChallengesInput };
